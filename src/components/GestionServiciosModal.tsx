...
export default function GestionServiciosModal({ open, onBack, categoria }: Props) {
    ...
    <>
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-2xl w-full rounded-2xl bg-white shadow-2xl">
            {/* Header */}
